...
class CustomerTherapistRepository extends EntityRepository
{
    public function getLeads(DateTime $startDate, DateTime $endDate)
    {
        $rsm = new ResultSetMapping();
        $rsm->addEntityResult(CustomerTherapist::class, 'c')
        ...
        $nativeQuery->setParameter('attribute_id', CustomerTherapist::ATTRIBUTE_ID_SPECIALISATION);
